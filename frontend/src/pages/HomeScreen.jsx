...
import { MOVIE_CATEGORIES, ORIGINAL_IMG_BASE_URL, TV_CATEGORIES } from "../constants/constants";
  ...
  return (
    ...
    <div className="relative h-screen text-white">
      ...
      <div className="flex mt-8">
        ...
        <Link to="/watch/1233" className="bg-gray-500/70 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded flex items-center">
